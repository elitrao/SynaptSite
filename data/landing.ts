...
export const cases: CaseStudy[] = [
  {
    ...
    image: "/assets/cases/foodtech-overview-v3.webp",
    imageAlt: "AI-движок для FoodTech с поиском рецептов и обработкой PDF-карт",
    gallery: [
      {
        src: "/assets/cases/foodtech-overview-v3.webp",
        alt: "Экран проекта AI-движка для FoodTech с мобильным интерфейсом",
      },
    ],
  ...
  },
  {
    ...
    image: "/assets/cases/consultant-overview-v2.webp",
    imageAlt: "AI-консультант с интеграцией корпоративной методологии",
    gallery: [
      {
        src: "/assets/cases/consultant-overview-v2.webp",
        alt: "Экран проекта автономного AI-консультанта",
      },
    ],
    video: { title: "Видео о проекте" },
    contentAlign: "right",
  },
  {
    ...
    image: "/assets/cases/sales-analytics-overview-v2.webp",
    imageAlt: "AI-аналитика коммуникаций отдела продаж",
    gallery: [
      {
        src: "/assets/cases/sales-analytics-overview-v2.webp",
        alt: "Экран проекта AI-аналитики отдела продаж",
      },
    ],
    video: { title: "Видео о проекте" },
    contentAlign: "left",
