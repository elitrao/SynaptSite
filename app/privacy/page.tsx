      ...
      <div className="site-container legal-page__inner">
        ...
        <div className="legal-page__content">
          ...
          <section>
            ...
            <p>
              Сайт обрабатывает имя, email, телефон и описание задачи, которые
              пользователь добровольно указывает в форме обращения.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Первая версия сайта не сохраняет заявки на сервере и не отправляет
              их в CRM. После заполнения формы письмо формируется в почтовом
              приложении пользователя. Предлагаемый срок хранения: {privacyConfig.storagePeriod}.
            </p>
          </section>
